...
class SaveButton(Button):
	...
	def __init__(self, painter, drawing_area, root, width, height, padx, pady):
		Button.__init__(self, painter, root, width, height, padx, pady)
		self.drawing_area = drawing_area
...
class UndoButton(Button):
	def __init__(self, painter, drawing_area, root, width, height, padx, pady):
		Button.__init__(self, painter, root, width, height, padx, pady)
		self.drawing_area = drawing_area
		self.TkBut = Tkinter.Button(root, text="Undo", command=self.button_event, width=width, height=height, bg="white")
		self.TkBut.pack(padx=padx, pady=pady, side=LEFT)
...
class Painter:
    ...
    def init_buttons(self, drawing_area):
        ...
        SaveButton(self, drawing_area, root, 5, 3, 2, 2)
        UndoButton(self, drawing_area, root, 5, 3, 2, 2)
        for i in range(16):
